package com.bchannel.kemendes.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "KemendesApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "KemendesApp API";

        private String description = "KemendesApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "KemendesApp";
